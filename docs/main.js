...
var _inkuzmin$elm_multiselect$Main$decodeUrl = _elm_lang$core$Json_Decode$list(
...
var _inkuzmin$elm_multiselect$Main$updateOutMsg = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'Selected':
				var _p3 = {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, 'Received Selected msg from Multiselect, key', _p2._0._0),
					_1: A2(_elm_lang$core$Debug$log, 'value', _p2._0._1)
				};
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Unselected':
				var _p4 = {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, 'Received Unselected msg from Multiselect, key', _p2._0._0),
					_1: A2(_elm_lang$core$Debug$log, 'value', _p2._0._1)
				};
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var _p5 = A2(_elm_lang$core$Debug$log, 'Received Cleared msg from Multiselect', '');
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _inkuzmin$elm_multiselect$Main$valuesC = {ctor: '[]'};
...
var _inkuzmin$elm_multiselect$Main$model = {
	...
	multiselectC: A2(_inkuzmin$elm_multiselect$Multiselect$initModel, _inkuzmin$elm_multiselect$Main$valuesC, 'C'),
	selectedA: {ctor: '[]'}
};
var _inkuzmin$elm_multiselect$Main$Flags = {};
var _inkuzmin$elm_multiselect$Main$Model = F4(
	function (a, b, c, d) {
		return {multiselectA: a, multiselectB: b, multiselectC: c, selectedA: d};
	});
var _inkuzmin$elm_multiselect$Main$Prepopulate = function (a) {
	return {ctor: 'Prepopulate', _0: a};
};
var _inkuzmin$elm_multiselect$Main$prepopulateValues = function () {
	var url = 'https://api.github.com/repos/inkuzmin/elm-multiselect/contributors';
	var request = A2(_elm_lang$http$Http$get, url, _inkuzmin$elm_multiselect$Main$decodeUrl);
	return A2(_elm_lang$http$Http$send, _inkuzmin$elm_multiselect$Main$Prepopulate, request);
}();
var _inkuzmin$elm_multiselect$Main$init = function (flags) {
	return {ctor: '_Tuple2', _0: _inkuzmin$elm_multiselect$Main$model, _1: _inkuzmin$elm_multiselect$Main$prepopulateValues};
};
var _inkuzmin$elm_multiselect$Main$SelectA = {ctor: 'SelectA'};
var _inkuzmin$elm_multiselect$Main$Yay = function (a) {
	return {ctor: 'Yay', _0: a};
};
var _inkuzmin$elm_multiselect$Main$Nyan = function (a) {
	return {ctor: 'Nyan', _0: a};
};
var _inkuzmin$elm_multiselect$Main$HOI = function (a) {
	return {ctor: 'HOI', _0: a};
};
	...
	function (msg, model) {
		...
		switch (_p6.ctor) {
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'HOI':
				var _p7 = A2(_inkuzmin$elm_multiselect$Multiselect$update, _p6._0, model.multiselectA);
				var subModel = _p7._0;
				var subCmd = _p7._1;
				var outMsg = _p7._2;
				return A2(
			...
			case 'Nyan':
				var _p8 = A2(_inkuzmin$elm_multiselect$Multiselect$update, _p6._0, model.multiselectB);
				var subModel = _p8._0;
				var subCmd = _p8._1;
				var outMsg = _p8._2;
				return A2(
			...
			case 'Yay':
				var _p9 = A2(_inkuzmin$elm_multiselect$Multiselect$update, _p6._0, model.multiselectC);
				var subModel = _p9._0;
				var subCmd = _p9._1;
				var outMsg = _p9._2;
				...
				var _p10 = function () {
					var _p11 = outMsg;
					if (_p11.ctor === 'Just') {
						return A2(_inkuzmin$elm_multiselect$Main$updateOutMsg, _p11._0, newModel);
					} else {
						return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
					}
				}();
				var newerModel = _p10._0;
				var outCommands = _p10._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					newerModel,
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _inkuzmin$elm_multiselect$Main$Yay, subCmd),
						_1: {
							ctor: '::',
							_0: outCommands,
							_1: {ctor: '[]'}
				...
				if (_p6._0.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								multiselectC: A3(
									_inkuzmin$elm_multiselect$Multiselect$populateValues,
									multiselectModel,
									values,
									{ctor: '[]'})
							}),
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Contributors (dynamic fetching of values)'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$map,
														_inkuzmin$elm_multiselect$Main$Yay,
														_inkuzmin$elm_multiselect$Multiselect$view(model.multiselectC)),
													_1: {
														ctor: '::',
														_0: _inkuzmin$elm_multiselect$Main$showSelected(
															_inkuzmin$elm_multiselect$Multiselect$getSelectedValues(model.multiselectC)),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _inkuzmin$elm_multiselect$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				_inkuzmin$elm_multiselect$Main$HOI,
				_inkuzmin$elm_multiselect$Multiselect$subscriptions(model.multiselectA)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_inkuzmin$elm_multiselect$Main$Nyan,
					_inkuzmin$elm_multiselect$Multiselect$subscriptions(model.multiselectB)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Platform_Sub$map,
						_inkuzmin$elm_multiselect$Main$Yay,
						_inkuzmin$elm_multiselect$Multiselect$subscriptions(model.multiselectC)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _inkuzmin$elm_multiselect$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _inkuzmin$elm_multiselect$Main$init, view: _inkuzmin$elm_multiselect$Main$view, update: _inkuzmin$elm_multiselect$Main$update, subscriptions: _inkuzmin$elm_multiselect$Main$subscriptions})(
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _inkuzmin$elm_multiselect$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _inkuzmin$elm_multiselect$Main$main !== 'undefined') {
    _inkuzmin$elm_multiselect$Main$main(Elm['Main'], 'Main', undefined);
}
